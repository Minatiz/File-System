...
struct fse et[] = {
    ...
    {FSE_COUNT, "Invalid count"},

    // Wrong file descriptor
    {FSE_FDER, "Wrong file descriptor"},
    // Check fs_open
    {FSE_OPENER, "CHECK FS_OPEN"},

    // File is a directory, can't remove
    {FSE_FILEISDIR, "File is a directory, can't remove"},

    // Cant remove directory since its not empty
    {FSE_DIRNOTEMPTY, "Cant remove directory since its not empty"}
